        ...
        const handleSubmit = async (event) => {
            ...
            try {
                ...
                if (response.data.UserNotExist) {
                    setError(response.data.UserNotExist); // Assuming that user already exists
                }
        ...
        <html>
            ...
            <body className="h-screen w-screen bg-gray-100 text-gray-900 flex justify-center" id ="bodySignIn">
                <div className="max-w-screen-xl m-0 bg-white shadow sm:rounded-lg flex justify-center flex-1 ">
                    <div className="lg:w-1/2 xl:w-5/12 p-4 sm:p-12 flex flex-col h-max">
                        <div>
                            <img
                                src={logo}
                        ...
                        <div className="flex flex-col items-center">
                            <h1 className="text-2xl xl:text-3xl font-extrabold mt-8">
                                Se connecter sur {APPLICATION_NAME}
                            </h1>
                            <div className="w-full flex-1 mt-8">
                                ...
                                <div className="mx-auto max-w-xs">
                                    ...
                                    <p className="mt-6 text-xs text-gray-600 text-center">
                                        Pas encore de compte ? <a href="/SignUp" className="text-indigo-500 border-b border-gray-500 border-dotted">Créez un compte</a>
                                    </p>
                                </div>
                            </div>
                        </div>
